...
\lstdefinelanguage{JavaScript}{
  keywords={typeof, new, true, false, catch, function, return, null, catch, switch, var, if, in, while, do, else, case, break, end, for},
...
\tableofcontents
    ...
    \include{sections/nonlinear}
    \include{sections/linear_eq}
    \include{sections/linear_eq_it}
    \include{sections/approximation}
    %\include{sections/code}
    %\include{sections/picture}
\end{document}